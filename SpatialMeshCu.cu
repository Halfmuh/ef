...
void SpatialMeshCu::allocate_ongrid_values() {
	...
	cudaMemset(dev_charge_density, 0, sizeof(double3) * total_node_count);
	cuda_status_check(cuda_status, debug_message);
	return;
}
